...
import com.teamfive.nettest.domain.enums.RoleEnum;
...
import com.teamfive.nettest.viewmodel.student.user.*;
...
public class UserController extends BaseApiController {
    ...
    public RestResponse register(@RequestBody @Valid UserRegisterVM model) {
        ...
        userEventLog.setContent("欢迎 " + user.getUserName() + " 注册来到考试系统");
